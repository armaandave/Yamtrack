...
from api.views.lists import (
    ...
    ListItemsView,
    ListLikeView,
    ListPeopleReorderView,
    ListPeopleView,
    ListPersonDetailView,
    ListsView,
)
...
urlpatterns = [
    ...
    path("me/profile-backdrop/", ProfileBackdropView.as_view(), name="api-me-profile-backdrop"),
    ...
    path("media/<str:source>/<str:media_type>/<str:media_id>/logos/", MediaLogosView.as_view(), name="api-media-logos"),
    ...
    path(
        ...
        name="api-music-recording-detail",
    ),
    path("media/<str:source>/<str:media_type>/<str:media_id>/", MediaDetailView.as_view(), name="api-media-detail"),
    path("people/search/", PeopleSearchView.as_view(), name="api-people-search"),
    path(
        "people/<str:source>/<str:person_id>/completion/",
        PersonCompletionView.as_view(),
        name="api-person-completion",
    ),
    path("people/<str:source>/<str:person_id>/", PersonDetailView.as_view(), name="api-person-detail"),
    path("series/<str:source>/<str:series_id>/", BookSeriesDetailView.as_view(), name="api-book-series-detail"),
    ...
    path(
        "companies/<str:source>/<str:company_id>/anime-options/",
        CompanyAnimeOptionsView.as_view(),
        name="api-company-anime-options",
    ),
    path(
        "companies/<str:source>/<str:company_id>/anime/",
        CompanyAnimeView.as_view(),
        name="api-company-anime",
    ),
    ...
    path("lists/<int:list_id>/people/", ListPeopleView.as_view(), name="api-list-people"),
    path(
        "lists/<int:list_id>/people/reorder/",
        ListPeopleReorderView.as_view(),
        name="api-list-people-reorder",
    ),
    path(
        "lists/<int:list_id>/people/<int:entry_id>/",
        ListPersonDetailView.as_view(),
        name="api-list-person-detail",
    ),
